...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.logoutmenu:
                ...
                Intent intent2 = new Intent(CustomerMapActivity.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mLogout.setOnClickListener(new View.OnClickListener() {
        ...
        // autocomplete locations using the place autocomplete API
    ...
    /*Function to find the closest driver to the customer
    * Geolocation radius
    * Pickup location is customers current latitude and longitude
    * pass pick up location to geoQuery*/
    ...
    private void getClosestDriver(){
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            /*
            * If driver found within the first mile radius, pass their location from firebase to app
            * */
            public void onKeyEntered(String key, GeoLocation location) {
                if (!driverFound && requestBol) {
                    ...
                    /*create child in database that will notify driver of a customer request
                    ...
                    /*
                     * get driver location
                     * pass location to customer*/
                    getDriverLocation();
                    getDriverInfo();
                    getHasRideEnded();
                    mRequest.setText("Searching for Driver Location....");
                }
            }
            ...
            @Override
            /*
            * i driver not found within the first radius, increment radius by one and search again*/
        ...
        driverLocationRefListener = driverLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && requestBol){
                    ...
                    /*
                    remove excess location markers
                    * */
                    ...
                    mDriverMarker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Your Driver").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_driver)));
                }
    ...
    private void getDriversAround(){
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                Marker mDriverMarker = mMap.addMarker(new MarkerOptions().position(driverLocation).title(key).icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_driver)));
